          ...
          <CardDeck className='justify-content-center'>
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/aikido'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Aikido} alt='NUS Aikido Club'/>
                </div>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/boxing'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Boxing} alt='NUS Boxing Club'/>
                </div>
                <Card.Body className='club-name'>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/capoeira'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Capoeira} alt='NUS Capoeira Club'/>
                </div>
                <Card.Body className='club-name'>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/karate'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Karate} alt='NUS Karate Club'/>
                </div>
                <Card.Body className='club-name'>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/kendo'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Kendo} alt='NUS Kendo Club'/>
                </div>
                <Card.Body className='club-name'>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/muaythai'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={MuayThai} alt='NUS Muay Thai Club'/>
                </div>
                <Card.Body className='club-name'>
            ...
            <Card className='club-card'>
              <a href={process.env.PUBLIC_URL + '/clubs/wushu'}>
                <div>
                  <Card.Img variant='top' className='project-image' src={Wushu} alt='NUS Wushu Club'/>
                </div>
                <Card.Body className='club-name'>
